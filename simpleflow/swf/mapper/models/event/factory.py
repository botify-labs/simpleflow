...
from simpleflow.swf.mapper.models.event.task import (
    ActivityTaskEvent,
    CompiledActivityTaskEvent,
    CompiledDecisionTaskEvent,
    DecisionTaskEvent,
)
from simpleflow.swf.mapper.models.event.timer import CompiledTimerEvent, TimerEvent
...
class EventFactory:
    ...
    an ``simpleflow.swf.mapper.models.event.Event`` subclass instance accordingly.
    ...
    will instantiate a ``simpleflow.swf.mapper.models.event.task.DecisionTaskEvent`` with state
    set to 'scheduled' from input attributes.

    raw_event: The input json event representation provided by
               amazon service

    :returns: ``simpleflow.swf.mapper.models.event.Event`` subclass instance
    """
...
class CompiledEventFactory:
    ...
    simpleflow.swf.mapper.models.event.compiler.CompiledEvent.
    """
