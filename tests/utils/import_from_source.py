# See https://medium.com/brexeng/avoiding-circular-imports-in-python-7c35ec8145ed
# This file contains tests that ensures imports are always done from the file where the objects
# are defined, which helps reducing the likeliness of circular dependency errors.
# Marginally adapted to work with a test directory outside of the source directory.
