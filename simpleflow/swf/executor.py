...
if TYPE_CHECKING:
    ...
    from swf import responses  # NOQA
...
class Executor(executor.Executor):
    ...
    def _make_task_id(self, a_task, workflow_id, run_id, *args, **kwargs):
        # Old name: stay compatible with potential users...
        return self.make_task_id(a_task, workflow_id, run_id, *args, **kwargs)

    def make_task_id(self, a_task, workflow_id, run_id, *args, **kwargs):
        """
