...
class TestMarkers(VCRIntegrationTest):
    ...
    def test_with_replays(self):
        ...
        assert len(decision_task_completed_event_id) == 3  # sent in different decisions
