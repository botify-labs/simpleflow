...
CHILD_WORKFLOW_STATES = set(simpleflow.swf.mapper.models.event.workflow.CompiledChildWorkflowExecutionEvent.states)


class History(simpleflow.swf.mapper.models.History):
    """
    ...
    def add_activity_task_timed_out(self, timeout_type, scheduled=None, started=None):
        if scheduled is None:
            scheduled = self.last_id - 1
    ...
    def add_child_workflow_start_initiated(
        self,
        workflow,
        workflow_id=None,
        task_list=None,
    ...
    def add_child_workflow_started(self, initiated_id):
    ...
    def add_child_workflow_completed(self, initiated_id, started_id, result=None):
        initiated_event = self.events[initiated_id - 1]
        workflow_id = initiated_event.workflow_id
        workflow_type = initiated_event.workflow_type
    ...
    def add_child_workflow_timed_out(self, initiated_id, started_id, timeout_type):
        initiated_event = self.events[initiated_id - 1]
        workflow_id = initiated_event.workflow_id
        workflow_type = initiated_event.workflow_type
    ...
    def add_child_workflow_canceled(self, initiated_id, started_id):
        initiated_event = self.events[initiated_id - 1]
        workflow_id = initiated_event.workflow_id
        workflow_type = initiated_event.workflow_type
    ...
    def add_child_workflow_terminated(self, initiated_id, started_id):
        initiated_event = self.events[initiated_id - 1]
        workflow_id = initiated_event.workflow_id
        workflow_type = initiated_event.workflow_type
    ...
    def add_child_workflow(
        ...
        started_id = self.last_id
        if last_state == "completed":
            self.add_child_workflow_completed(initiated_id, started_id, result=result)
        elif last_state == "failed":
