...
class WorkflowTypeQuerySet(BaseWorkflowQuerySet):
    ...
    def get(self, name, version, *args, **kwargs):
        ...
        :rtype:  simpleflow.swf.mapper.core.model.workflow.WorkflowType
    ...
    def filter(
        ...
        **kwargs,
        ...
        :type       domain: simpleflow.swf.mapper.models.domain.Domain
...
class WorkflowExecutionQuerySet(BaseWorkflowQuerySet):
    ...
    def all(
        ...
        **kwargs,
        ...
        :type   status: simpleflow.swf.mapper.models.WorkflowExecution.{STATUS_OPEN, STATUS_CLOSED}
