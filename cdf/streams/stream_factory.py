...
class FileStreamFactory(object):
    ...
    def _get_crawler_metakeys(self):
        ...
        Crawler metakeys are stored in 'files.json'"""
    ...
    def _get_file_list(self, crawler_metakeys):
        ...
        crawler_metakeys : the crawler metakeys
                           (as returned by _get_crawler_metakeys)
    ...
    def get_stream(self):
        ...
        crawler_metakeys = self._get_crawler_metakeys()
        files = self._get_file_list(crawler_metakeys)
